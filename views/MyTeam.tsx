...
const MyTeamView: React.FC<MyTeamViewProps> = ({ teamId, userId }) => {
  ...
  const [paymentForm, setPaymentForm] = useState({
    months: [] as number[], // Agora aceita vÃ¡rios meses
    year: 2026,
  ...
  if (!team) return <div className="p-10 text-center font-black">EQUIPE NÃO encontrada</div>;
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] flex items-center gap-2">
                <MapPin className="w-3.5 h-3.5 text-blue-500" /> {team.city} â€¢ UNIDADE {team.state}
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
             ...
             <div className="bg-white p-8 rounded-[2.5rem] border border-red-100 shadow-xl shadow-red-50 relative overflow-hidden group">
                ...
                <p className="text-[10px] font-black text-red-400 uppercase tracking-[0.2em] mb-1">PendÃªncias Acumuladas</p>
                <h3 className="text-4xl font-black text-red-600 tracking-tighter leading-none">R$ {financeStats.pendingAmount.toFixed(2)}</h3>
                <p className="mt-4 text-[9px] font-bold text-gray-400 italic">ZÃ©, esse Ã© o valor que ainda falta entrar no caixa este ano.</p>
             </div>
          </div>
          ...
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm overflow-hidden">
             <header className="p-8 border-b border-gray-50 flex items-center justify-between bg-gray-50/20">
                <div>
                   ...
                   <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1">Legenda: <span className="text-emerald-500">â— Pago</span> | <span className="text-red-500">â— Atraso</span> | <span className="text-gray-300">â—‹ Futuro</span></p>
                </div>
              ...
              <table className="w-full text-left">
                 <thead>
                    <tr className="bg-gray-50/50">
                       ...
                       <th className="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest">ReferÃªncia</th>
                       <th className="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest">Data LanÃ§.</th>
            ...
            <div className="bg-white w-full max-w-2xl rounded-[3rem] shadow-2xl flex flex-col overflow-hidden border border-gray-100 animate-in zoom-in-95 duration-500">
                <div className="p-10 border-b border-gray-50 bg-white text-center flex flex-col items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-2">MARQUE OS MESES ABAIXO PARA LANÃ‡AR EM LOTE</p>
                    </div>
                </div>
                ...
                <div className="p-10 space-y-10 overflow-y-auto max-h-[60vh] no-scrollbar">
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">ObservaÃ§Ãµes (Opcional)</label>
                        <textarea 
                            rows={2}
                            placeholder="ZÃ©, anote aqui se foi PIX ou dinheiro..."
                ...
                <div className="p-10 bg-gray-50 border-t border-gray-100 flex flex-col gap-4">
                    ...
                    >
                        <Save className="w-5 h-5" /> Confirmar LanÃ§amento ({paymentForm.months.length} Meses)
                    </button>
                    <button 
